...
/**
 * charger la classe de chargement des autres calsses
 * autoloader
**/
require_once((__DIR__) ."/../../appLoader.class.php"); // require de la classe 
// (__DIR__) remplace "dirname(__FILE__)".

$appLoader = new appLoader(); //appel de la classe
/**
